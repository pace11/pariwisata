            ...
            <div class="col-md-12">
                <div class="card card-default">
                                ...
                                <div class="card-body">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <button class="btn btn-success btn-sm"><?= $data['id_kategori'] ?></button>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5">
                                            ...
                                            <div class="col-md-7">
                                                <button class="btn btn-success btn-sm"><i class="fas fa-map-marker"></i> Objek Wisata</button>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5">
                                            ...
                                            <div class="col-md-7">
                                                <button class="btn btn-success btn-sm"><?= $data['id_daerah'] ?></button>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5">
                    ...
                    <div class="card-footer">
                        <a href="?page=objekwisata" class="btn btn-info"><i class="fas fa-chevron-circle-left"></i> Kembali</a>
                    </div>
                    </form>
                </div>
            </div>
