            ...
            <div class="col-md-12">
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="?page=kulinereditpro" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button class="btn btn-info"><?= $data['id_kategori'] ?></button>
                                        ...
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input type="text" class="form-control" name="nama" placeholder="masukkan nama hotel ..." value="<?= $data['nama'] ?>" required>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <textarea class="form-control" name="alamat" rows="3" placeholder="masukkan alamat hotel ..." required><?= $data['alamat'] ?></textarea>
                                        </div>
                                        <div class="form-group">
