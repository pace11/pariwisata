                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="callout callout-danger">
                                    ...
                                    <form action="?page=kulinerhapus" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="id_kategori" value="<?= $_GET['id'] ?>">
                                        <input class="btn btn-danger" type="submit" name="submit" value="Ya">
                                        <a class="btn btn-info" href="?page=kuliner"><i class="fas fa-chevron-circle-left"></i> Kembali</a>
                                    </form>
                                </div>
                            </div>
                        </div>
