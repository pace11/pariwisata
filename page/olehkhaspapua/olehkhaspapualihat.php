            ...
            <div class="col-md-12">
                <div class="card card-default">
                                ...
                                <div class="card-body">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <button class="btn btn-primary btn-sm"><?= $data['id_kategori'] ?></button>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5">
                                            ...
                                            <div class="col-md-7">
                                                <button class="btn btn-primary btn-sm"><i class="fas fa-gift"></i> Oleh-Oleh Khas Papua</button>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5">
                                            ...
                                            <div class="col-md-7">
                                                <button class="btn btn-primary btn-sm"><?= $data['id_daerah'] ?></button>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <a href="?page=kuliner" class="btn btn-info btn-sm"><i class="fas fa-utensils"></i> Kuliner</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-footer">
                        <a href="?page=olehkhaspapua" class="btn btn-info"><i class="fas fa-chevron-circle-left"></i> Kembali</a>
                    </div>
                    </form>
                </div>
            </div>
