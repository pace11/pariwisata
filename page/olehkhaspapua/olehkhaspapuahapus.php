                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form action="?page=olehkhaspapuahapus" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="id_kategori" value="<?= $_GET['id'] ?>">
                                    <input class="btn btn-danger" type="submit" name="submit" value="Ya">
                                    <a class="btn btn-info" href="?page=olehkhaspapua"><i class="fas fa-chevron-circle-left"></i> Kembali</a>
                                </form>
                                </div>
                            </div>
                        </div>
